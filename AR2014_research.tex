...
A subproject on developing improved ways of describing the nuclear chromatin patterns based on new image analysis methods has been spun off and is describe as project \ref{proj:high_prec_lifeSci} (Advanced methods for reliable and cost efficient image processing in life sciences)
...
\begin{figure}[!htbp]
	\centering
	\subfigure[]{\includegraphics[width=0.4\textwidth]{figures/research/segglandpros.png} \label{fig:segglandpros}}
	\subfigure[]{\includegraphics[width=0.4\textwidth]{figures/research/segnucleipros.png}\label{fig:nucleipros}}
...
\ppartners{Mats Nilsson, Thomas Hauling, Marco Mignardi, Jessica Svedlund, Elin Lundin,Xiaoyan Qian, Department of Biochemistry and Biophysics and SciLifeLab, Stockholm University.}
\ffunding{SciLifeLab}
\pperiod{1308--}
